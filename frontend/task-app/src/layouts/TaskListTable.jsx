            ...
            <tbody>
              {tableData.map((task) => (
                  <tr key={task._id} className="border-t border-gray-200">
                      ...
                      <td className="p-4">
                          <span className={`px-2 py-1 text-sm rounded inline-block ${getStatusBadgeColor(task.status)}`}>{task.status}</span>
                      </td>
                      <td className="p-4">
                          <span className={`px-2 py-1 text-sm rounded inline-block ${getPriorityBadgeColor(task.priority)}`}>{task.priority}</span>
                      </td>
