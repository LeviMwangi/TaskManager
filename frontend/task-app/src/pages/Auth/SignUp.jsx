...
const SignUp = () => {
  ...
  // Reset state when page reloads or component mounts
  useEffect(() => {
    setProfilePic(null);
    setFullName('');
    setEmail('');
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      console.error('Sign-Up Error:', error); // Logs the error for debugging
      ...
      <div className="bg-[#7ad3f62a] flex rounded-2xl shadow-lg max-w-4xl w-full sm:flex-row flex-col">
        ...
        <div className="sm:w-1/2 w-full px-8 py-4 flex flex-col justify-center items-center">
          ...
          >
            ...
            <button 
              className="bg-blue-500 rounded-xl text-white py-2 hover:bg-blue-600 cursor-pointer" 
              type="submit"
            >
              Sign Up
            </button>
